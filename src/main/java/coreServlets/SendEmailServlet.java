	...
	public String getMailText(String type, String user, String usermail, String userpass, String activation, int id) {
		...
		if(type.equals("register")){
			email = 
					...
					+ "<br>"
					+ "Uw account moet eerst geactiveerd worden. Dit kunt u doen door <a href=\"http://datainfo.ewi.utwente.nl/di13_concordia/activateAccount?link="+activation+"&id="+id+"\">hier</a> te klikken.<br>"
					+ "Tevens is het mogelijk om uw account te activeren op de volgende manier te activeren:<br>"
					+ "Login op http://datainfo.ewi.utwente.nl/di13_concordia/ en ga vervolgens naar http://datainfo.ewi.utwente.nl/di13_concordia/activation.jsp<br>"
